...
<NavigationStack.Root>
	...
	<div class="flex flex-col gap-20 px-6 py-12 w-full max-w-4xl">
		...
		<div class="flex flex-col gap-3">
			...
			<div
				class="h-64 w-full flex flex-col items-center justify-center bg-[url(https://www.iclarified.com/images/news/97554/465552/465552.jpg)] bg-cover rounded-3xl relative border border-border/20 shadow-md overflow-hidden group gap-4"
			>
				<div class="absolute inset-0 bg-black/10 backdrop-blur-xs"></div>

				<div class="relative z-10 flex flex-col items-center gap-4">
					<ButtonGroup.Root {variant} {size} {specular} {magnetic} {scale} class="shadow-2xl border border-white/10">
